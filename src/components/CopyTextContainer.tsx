...
export default function CopyTextContainer(props: CopyTextContainerProps) {
    ...
    return (
        <div
            ...
            className={'group select-none w-fit overflow-hidden h-11 md:h-12 cursor-pointer ' + (props.className ?? '')}>
            <div
                ...
                <div
                    ...
                    className={
                        'px-4 pb-2 pt-4 -mt-2 bg-card-background text-primary-red text-end '
                        + 'text-lg md:text-2xl group-hover:-mt-[3.25rem] md:group-hover:-mt-14 duration-200'
                    }>
                    <div className='flex justify-between items-center gap-x-8 md:gap-x-16'>
                        <FontAwesomeIcon icon={['fas', 'envelope']}/>
                        {props.text}
                    </div>
                </div>
                <div className='size-full text-white bg-primary-red pt-2 pb-4 -mb-2 text-end text-lg md:text-2xl pe-4 origin-top-left'>
                    {isCopied ?
